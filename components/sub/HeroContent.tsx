                ...
                >
                    <div className="h-full w-full md:w-3/6 flex flex-col gap-5 justify-center text-start">
                        <div className="hidden md:flex flex-row items-center md:gap-5 gap-1">
                            {copy.hero.badges.map((badge, index) => (
                                <InView key={`${badge}-${index}`} triggerOnce={false}>
                                    {({ inView, ref }) => (
                                        <motion.div
                                            ref={ref}
                                            initial="hidden"
                                ...
                                >
                                    <span>
                                        ...
                                        <ShinyText
                                            ...
                                            text={copy.hero.title.highlightOne}
                                        />{" "}
                                        {copy.hero.title.middle}{" "}
                                        <ShinyText
                                            className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500"
                                            text={copy.hero.title.highlightTwo}
                                        />{" "}
                    ...
                    <InView triggerOnce={false}>
                        {({ inView, ref }) => (
                            ...
                            >
                                <img
                                    src={copy.hero.imageUrl || "/mainIconsdark.svg"}
                                    alt="hero"
                                    width={650}
                                    height={650}
